...
<?php
/**
 * German Zs 3v Light Distant Speed Signal
 * @author sb12
 *
 */
Class Speedlimit_zs3v_light
{
	...
	{
		$speed = "";
		$speed_array = array(60, 80);
		if(isset($_GET["railway:signal:speed_limit_distant:speed"]))
		{
			$speeds = $_GET["railway:signal:speed_limit_distant:speed"];
		...
		$image .= Signal_matrix::getMatrix($speed, $speed_array, "&stv");
